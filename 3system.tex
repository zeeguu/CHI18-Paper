...
The current implementation of the text recommender allows the reader to select online sources (e.g. news, blogs) that are interesting for them. The sources are scanned for the latest articles and cached by using a custom-made library\footnote{The library called {\em watchmen} is open source at:\\ https://github.com/zeeguu-ecosystem/watchmen}. 
