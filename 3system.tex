...
% \subsection{A Personalized Textbook as a Minimum Viable Ecosystem}
...
The Translation Service is implemented using Python. However, we did not want to implement the translation service ourselves. Instead, we decided to rely on third party services: GT, MT, etc. Moreover, we found a way to provide contextual translations \ml{to explain this...}
