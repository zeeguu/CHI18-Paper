...
{\bf Usage Scenario. }
	...
	He encouraged them to read texts they found interesting and to build up their own {\em personalized portfolio of words}, complementary to the list of common mandatory words that each class had to study.
	...
	The teacher had used this strategy in the past with other software. 
	% This might have affected negatively the willingness of the students to spend time on the platform.
% \end{added}


{\bf Deployment.} At the beginning of June 2017, we introduced the system and its usage in each of the three classes. With few exceptions the students created an account and started using the system the latest on June 9th and until the end of the month, which coincided with the end of the study year. 
% \begin{added}
Students used personal computers and Android/iOS phones.
% \end{added}

Before creating accounts on our platform, the participants had to fill in a survey form with information about their current level of knowledge, learning strategies, and interests. Nevertheless, a handful of the participants did not fill the survey.
