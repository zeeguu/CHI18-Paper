...
The teacher who deployed the system in the class asks the students to provide feedback at the end of the year about the methods and tools used in class. Multiple students provided very similar feedback to the one who said: {\em ``It works well but it were better if the translation would have been in Dutch. It is good that you can choose yourself what to read.''}\footnote{In original: ``Werkt goed maar als vertaling NL was geweest was het beter geweest. Goed dat je zelf kan kiezen wat je leest''. For the other answers, we invite the reader to visit the data folder available at \repo}
