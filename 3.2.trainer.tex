...
\begin{description}
	\item [Free text input] where the text must be typed in the learned language (similar to the figure above)
	\item [Multiple choice] where the user is presented with a set of alternatives.
\end{description}
